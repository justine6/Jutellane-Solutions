      ...
      <AnimatedSection>
        <section className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 mb-12">
            <a
              href="#contact"
              className="bg-blue-600 text-white py-2 px-6 rounded-xl text-lg hover:bg-blue-700"
            >
              Book a Free Assessment
            </a>
            <a
              href="/brochure.pdf"
              className="border border-blue-600 text-blue-600 py-2 px-6 rounded-xl text-lg hover:bg-blue-50"
            >
              Download Brochure
            </a>
          </div>
