  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 px-4 sm:px-6 py-8 sm:py-10 scroll-smooth">
      ...
      <AnimatedSection>
        <div className="mb-8">
          <Image
            src="/aws.banner.png" // ✅ Updated file name
      ...
      <AnimatedSection>
        <section
          id="blog"
          className="scroll-mt-20 max-w-3xl mx-auto text-center px-4 mb-16"
        >
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4">
            Stay Updated
          </h2>
          <p className="text-base sm:text-lg text-gray-700 mb-6">
            🚧 Our blog and newsletter are coming soon! You’ll soon be able to
            explore in-depth insights, DevSecOps tips, and cloud automation
            tutorials curated by Justine Tekang.
          </p>
          <NewsletterSignup />
        </section>
      </AnimatedSection>
